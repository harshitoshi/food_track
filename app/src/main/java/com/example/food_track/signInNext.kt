...
import com.google.firebase.auth.PhoneAuthCredential as AuthPhoneAuthCredential

class signInNext : AppCompatActivity() {
        ...
        verifyBtn.setOnClickListener {
            ...
            if (typedOTP.isNotEmpty()) {
                if (typedOTP.length == 6) {
                    val credential: com.google.firebase.auth.PhoneAuthCredential = PhoneAuthProvider.getCredential(
                        OTP, typedOTP
                    )
